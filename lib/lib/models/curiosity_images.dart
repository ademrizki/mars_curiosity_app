class CuriosityImages {
  List<Photos> photos;

  CuriosityImages({this.photos});

  CuriosityImages.fromJson(Map<String, dynamic> json) {
    if (json['photos'] != null) {
...
class Photos {
  ...
  Photos({this.id, this.sol, this.camera, this.imgSrc, this.earthDate, this.rover});
